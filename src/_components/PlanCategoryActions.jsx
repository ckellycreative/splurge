...
function PlanCategoryActions(props) {
	return(
        <ul className="dropdown-menu">
            ...
            {props.actions.editPlan && <li><a className="dropdown-item" onClick={() => props.handleClickEditPlan(props.cat.CategoryPlan.id, props.cat.CategoryPlan.planAmount, props.cat.ChildCategory.id)}>Change Plan Amount</a></li>}
            {props.actions.hide && <li><a className="dropdown-item"  onClick={() => props.handleClickHideCategory(props.cat.ChildCategory.id, props.hasAmts)}>Hide</a></li>}
